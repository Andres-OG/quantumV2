...
// Ruta para obtener pisos por edificio (para la selección dinámica en el formulario)
Route::get('/pisos-by-edificio/{edificio}', function($edificio) {
    return \App\Models\Piso::where('edificio_id', $edificio)->get(['id', 'numero']);
})->name('pisos.by.edificio');

Route::get('/salones/pisos/{idEdificio}', [SalonController::class, 'getPisosPorEdificio']);
