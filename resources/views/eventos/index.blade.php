            ...
            <tbody>
                @foreach ($eventos as $evento)
                    <tr>
                        ...
                        <td>{{ ucfirst($evento->dia) }}</td> <!-- Capitalizar el primer caracter del día -->
                        <td>{{ $evento->salon->nombre ?? 'Sin asignar' }}</td> <!-- Mostrar nombre del salón o 'Sin asignar' si no está relacionado -->
                        <td>
